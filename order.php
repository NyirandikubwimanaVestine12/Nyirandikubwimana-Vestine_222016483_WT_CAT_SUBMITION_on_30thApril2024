...
<center>
	...
	<section class="forms">
<form action="orders.php" method="POST" class="sp" onsubmit="return confirmInsert();">
	<h3 style="color:green;">CUSTOMER ORDERS FORM</h3>
    ...
    <select name="product_id" id="product_id" class="input"> 
    	  	<!-- here are php code that help to retrieve product id on order on screen you see productname but in database save product id-->
        <?php
    ...
    <input type="text" name="quantity" required class="input"><br>
    <label>Payments Methods</label><br>
    <input type="text" name="paymentmethods" class="input" required><br>  
    <label>Phone Number</label><br>
    <input type="text" name="phone" required class="input"><br> 
    <label>Order_Date</label><br>
    <input type="date" name="order_date" required class="input"><br>
    <input type="submit" name="submit" value="Order Now" class="sb">

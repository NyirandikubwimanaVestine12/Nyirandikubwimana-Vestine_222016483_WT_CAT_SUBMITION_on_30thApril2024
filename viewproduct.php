...
<body>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold; color:blue;">LIST OF PRODUCT IN OUR ENTERPRISE</h4>
        <a href="products.php" class="btn btn-primary" style="margin-top: 0px;">New Product</a>
